...
class MusicPlayer : AppCompatActivity() {
    ...
    private lateinit var farward: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        musicTracks = welcomePageViewModel.getMusicTrack(this)
    ...
    private fun setupMusicControls() {
        ...
        farward=findViewById<ImageView>(R.id.forword)
        farward.setOnClickListener {
            moveForward()
        }
    }
